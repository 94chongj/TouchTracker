...
//  TouchTracker
//
//  Created by Jonathan Chong on 8/29/18.
...
class DrawView: UIView, UIGestureRecognizerDelegate{
    ...
    func indexOfLine(at point: CGPoint) -> Int? {
        ...
        //If nothing is close enough to the tapped point, then we did not select a line return nil
        return nil
    }
    ...
    @objc func tap(_ gestureRecognizer: UIGestureRecognizer) {
        ...
        if selectedLineIndex != nil {
            //Make DrawView the target of menu item action messages ~ For a menu controller to appear,
    ...
    @objc func moveLine(_ gestureRecognizer: UIPanGestureRecognizer) {
        ...
        if let index = selectedLineIndex {
            //print(gestureRecognizer.velocity(in: DrawView))
